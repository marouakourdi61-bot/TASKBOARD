                ...
                <form method="POST" action="{{ route('tasks.store') }}" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-6">
                            ...
                            >
                                ...
                                <option value="moyenne" {{ old('priority') == 'moyenne' ? 'selected' : '' }} selected>Moyenne</option>
                    ...
                    <div class="mb-6">
                        ...
                        <select 
                            ...
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                        >
                            <option value="à_faire" {{ old('status') == 'à_faire' ? 'selected' : '' }} selected>À Faire</option>
                            <option value="en_cours" {{ old('status') == 'en_cours' ? 'selected' : '' }}>En Cours</option>
                            <option value="en_revue" {{ old('status') == 'en_revue' ? 'selected' : '' }}>En Revue</option>
